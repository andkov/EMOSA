...
p
plast<-p
pathFileOut<-file.path(getwd(),"Results","Sketches2","observed_1x1_prevalences_age.png") 
...
p
plast<-p
pathFileOut<-file.path(getwd(),"Results","Sketches2","observed_1x1_prevalences_years.png") 
png (filename = pathFileOut ,
     width = 350, height = 300 , units = "px")
plot(plast)
dev.off()